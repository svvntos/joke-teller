...
// this function connects the vocie api and joke api
function tellMe(joke) {
    VoiceRSS.speech({
        key: '14a14b6aa3874346b8174aa70b3443b9',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0,
...
// Genorating the joke from the api
...
//Event listner for the button to tell the joke

button.addEventListener('click' || 'touchend', getJoke);
